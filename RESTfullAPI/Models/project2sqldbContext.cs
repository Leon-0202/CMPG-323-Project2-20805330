...
{
    public partial class project2sqldbContext : DbContext
    {
        public project2sqldbContext()
        {
        }

        public project2sqldbContext(DbContextOptions<project2sqldbContext> options)
            : base(options)
        {
        }
